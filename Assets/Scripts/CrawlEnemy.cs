...
public class CrawlEnemy : BasicEnemy, IDamageable
{
    ...
    void FixedUpdate()
    {
        if (isDead == false)
        {
            ...
            //Change enemyHead to an offset variable like in PlayerController at some point for consistancy
            Vector3 enemyHead = gameObject.transform.position + new Vector3(rayDistanceHorizontal*direction,0,0);
